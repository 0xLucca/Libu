          ...
          <div className="w-full h-full p-3">
            <div className="h-1/5 flex">
              <div className="my-auto">
                <h1 className="text-3xl font-inter font-bold">{nft.name}</h1>
                <h2 className="text-xl font-sora">{nft.address}</h2>
              </div>
            </div>
            <div className="h-2/5 my-auto flex">
              <div className="my-auto w-4/5">
                <p className="text-lg font-sora text-libuBlack">
                  {nft.address}
                </p>
              </div>
            </div>
              ...
              <div className="my-auto w-full">
                <div className="lg:flex">
                  ...
                  font-sora
                    ...
                    "
                  >
                    <div className="m-auto">comprar</div>
                  </button>
                </div>
              </div>
            </div>
